...
## Opérateur de convolution {.smaller}


::: {#fig-convol layout-ncol=2}

![](img/convol_gen.png){width="50%"}

![](img/convol_calc.png){width="50%"}

Illustration de l'opérateur de convolution 2-dimensionnel $\star$. 
:::
...
- Application sur le [site web du cours](https://inseefrlab.github.io/cours-nouvelles-donnees-site/images_exemples.html) sur la classification d'oiseaux et le traitement d'images satellites 
- Entraîner un modèle de classification d'oiseaux avant de traiter des images satellites pour effectuer de la reconnaissance de terrains, avec {{< fa brands python >}} et `scikit-learn`
